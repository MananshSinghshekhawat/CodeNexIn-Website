  ...
  try {
    ...
    const defaultContent = {
      heroSection: {
        ...
        subtitle:
          "From custom software development to AI implementation, we offer a full spectrum of technology services to help your business thrive in the digital age.",
      },
      services: [
        {
          ...
          description:
            "End-to-end software solutions tailored to your specific business needs and requirements.",
          icon: "💻",
          keyFeatures: [
          ...
          useCases: [
            {
              industry: "Healthcare",
              description:
                "Custom EHR systems and patient management solutions",
            },
            {
              industry: "Finance",
              description:
                "Secure banking and financial management applications",
            },
            {
              industry: "Retail",
              description:
        ...
        },
        {
          ...
          useCases: [
            ...
            },
            {
              industry: "E-commerce",
              description:
                "Personalized recommendations and customer behavior prediction",
            },
            {
        ...
        },
        {
          ...
          description:
            "Comprehensive digital strategy and implementation to modernize your business operations.",
          icon: "🔄",
          keyFeatures: [
          ...
          useCases: [
            ...
            },
            {
              industry: "Education",
              description:
                "Digital learning platforms and student management systems",
            },
            {
              industry: "Government",
        ...
        },
        {
          ...
          description:
            "Native and cross-platform mobile applications that engage and delight your users.",
          icon: "📱",
          keyFeatures: [
        ...
        },
        {
          ...
          useCases: [
            ...
            },
            {
              industry: "Non-profit",
              description:
                "Cost-effective technology solutions and implementation",
            },
          ],
          ctaButton: {
            text: "Get Started",
      ...
      industries: [
        {
          name: "Healthcare",
          description:
            "HIPAA-compliant solutions for medical practices and healthcare providers",
          icon: "🏥",
          isActive: true,
        },
        {
      ...
      ctaSection: {
        ...
        description:
          "Let's discuss how our technology solutions can help you achieve your business goals. Our team of experts is ready to guide you through your digital transformation journey.",
        buttons: [
          {
...
// Get single service by slug - FIXED
